...
class WCP_BackEnd_ContactInformation_Controller {
	...
	add_action( 'wp_ajax_WCP_BackEnd_ContactInformation_Controller::save_paypal_configuration', Array('WCP_BackEnd_ContactInformation_Controller','save_paypal_configuration'));
	add_action( 'wp_ajax_nopriv_WCP_BackEnd_ContactInformation_Controller::save_paypal_configuration', array('WCP_BackEnd_ContactInformation_Controller', 'save_paypal_configuration'));
?>
